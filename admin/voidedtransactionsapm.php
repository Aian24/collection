...
<body id="page-top">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap align-items-end mb-4" style="gap: 12px; background-color: #f8fafc; padding: 16px; border-radius: var(--radius-lg); border: 1px solid #e2e8f0;">
                    ...
                    <div style="min-width: 200px;">
                        ...
                        <select id="branch" class="form-control form-control-modern" disabled style="background-color: #e2e8f0; cursor: not-allowed;">
    ...
    <!-- External Scripts (Injected to fix missing jQuery and DataTables) -->
