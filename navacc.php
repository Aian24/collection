...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="adminacc.php">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto"> <li class="nav-item">
                    <a class="nav-link" href="collectionacc.php"><i class="fas fa-money-check-alt me-1"></i> Collection</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="tenantsacc.php"><i class="fas fa-users me-1"></i> Tenants</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="voidedtransactionsacc.php"><i class="fas fa-undo-alt me-1"></i> Voided Transact</a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link" href="soaacc.php"><i class="fas fa-file-invoice me-1"></i> SOA</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="adminacc.php"><i class="fas fa-tachometer-alt me-1"></i> Dashboard</a>
                </li>
            </ul>
        </div>
    </div>
