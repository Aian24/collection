...
<head>
    ...
    <style>
        ...
        /* Optional: Adjust body padding to prevent content from being hidden by fixed navbar */
        body {
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto"> <li class="nav-item">
                    <a class="nav-link" href="collection.php"><i class="fas fa-money-check-alt me-1"></i> Collection</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="tenants.php"><i class="fas fa-users me-1"></i> Tenants</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="voidedtransactions.php"><i class="fas fa-undo-alt me-1"></i> Voided Transact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="usersadmin.php"><i class="fas fa-user-cog me-1"></i> Users</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="soa.php"><i class="fas fa-file-invoice me-1"></i> SOA</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="tenant_history.php"><i class="fas fa-history me-1"></i> Tenant History</a>
                </li>
                <li class="nav-item">
